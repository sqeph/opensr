...
#@decorator                                                                      #anfang hinzugefuegt
#def has_code(f, request):
#    if not 'code' in request.session:
#        return get_redirection(request)
#    return f(request)
#
#@decorator
#def has_no_code(f, request, *args):
#    if 'code' in request.session:
#        return get_redirection(request)
#    return f(request) if len(args) == 0 else f(request, args[0])                #ende hinzugefuegt
